...
class SpinnerAdapter(context: Context, resId: Int, var daysList: List<String>) :
    ...
    private fun getCustomView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val row = LayoutInflater.from(parent.context).inflate(R.layout.item_spiner_row, parent, false)

        val text = row.findViewById<TextView>(R.id.dayOfWeek)
        text.text = daysList[position]
